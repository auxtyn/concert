  ...
  return (
    <div>
      <section className="c-space">
        <section className="lyrics mb-5 mt-5 pt-5">
          {/* <h2 className="text-heading mb-5 mt-5 pb-5 text-center">
            Songs list
          </h2> */}

          <h1 className=" text-center text-cyan-100 text-3xl mt-5 pt-5">
            I will enter his gates by Zitu Benafa
          </h1>
          <p className="subtext mb-5 text-center text-2xl">
            ...
            <br />
            He has made me glad, He has made me glad,
            <br />I will rejoice for He has made me glad.
          </p>
          <hr />
        </section>
        <section className="lyrics mt-5">
          <h1 className=" text-center text-cyan-100 text-3xl mb-5">
